...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: the Dequeue() method didnt remove the person standing in the first position, but the one in the last.
    ...
    // Defect(s) Found: This one worked for me after fixing the first one.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The method GetNextPerson() didnt work with number of turns equal or smaller than 0
    ...
    // Defect(s) Found: this one worked without changing anything else
